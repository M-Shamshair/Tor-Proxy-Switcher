...
"""
tor_proxy_switcher.py
A light GUI program for Windows, Linux, Ubunto and other all operating system.
Only you need to installed Python environment on it.
It will change your browser IP address automatically where TOR is connected with Vidalia Control Panel.
only you need to give time Interval in Seconds. (To set the change proxy Delay)
...
class Switcher(Tk):
    def __init__(self):
        ...
        self.output = Text(self, foreground="white", background="black", highlightcolor="white", highlightbackground="purple", wrap=WORD, height = 10, width = 40)
    ...
    def stop(self):
        try:
            ...
            print 'TOR Switcher Stopped.'
        except:
            pass
        self.ident = random.random()
	
    def exit(self):
        self.write('TOR Switcher Closed.')
